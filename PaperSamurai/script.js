...
var paper_scale = 5.0; //h/200 //0.5;

var fireRate = 1000;
var nextFire = 0;
var background_dojo_paths = []
var background_dojo = []
var background_16_9_paths = []
var background_16_9 = []
var background_9_16_paths = []
var background_9_16 = []
var background_animated_paths = []
var background_animated = []
...
function setupEmitters(){
  ...
  spriteMask.visible = false
    ...
    //scale this to be proportional to the height
  ...
  //glassSprite.scale.setTo(glassSprite.width, glassSprite.height);
  glassSprite.scale.setTo(0.25,0.25);
  //console.log(glassSprite)
...
function resetScore() {
  ...
  scoreLabel.text = 'Slash papers not glass!!';
...
class BootState extends Phaser.State {
  ...
  preload(){
       ...
       //Preload assets
      game.load.image("preloadbar", "assets/images/ui/Preloadbar_0.png") //https://leokamwathi.github.io/PixelNinja
       game.load.image("logo","assets/images/title/title_logo_2.png")
       game.load.audio("intro_music","assets/sounds/start_menu.mp3")
...
class LoadingState extends Phaser.State {
  ...
  //game.stage.backgroundColor = "#00ccff";//87ceeb
      ...
      background_dojo_paths.push('assets/images/dojos/dojo_01.jpg')
      background_dojo_paths.push('assets/images/dojos/dojo_02.jpg')
      background_dojo_paths.push('assets/images/dojos/dojo_03.jpg')
      background_dojo_paths.push('assets/images/dojos/dojo_04.jpg')
      background_dojo_paths.push('assets/images/dojos/dojo_05.jpg')
      background_dojo_paths.push('assets/images/dojos/dojo_06.jpg')
      background_dojo_paths.push('assets/images/dojos/dojo_07.jpg')

      background_animated_paths.push('assets/images/backgrounds/animated/animated_001.gif');
      background_animated_paths.push('assets/images/backgrounds/animated/animated_002.gif');
      background_animated_paths.push('assets/images/backgrounds/animated/animated_003.gif');

      background_16_9_paths.push('assets/images/backgrounds/16_9/16_9_001.jpg');
      background_16_9_paths.push('assets/images/backgrounds/16_9/16_9_002.jpg');
      background_16_9_paths.push('assets/images/backgrounds/16_9/16_9_003.jpg');
      background_16_9_paths.push('assets/images/backgrounds/16_9/16_9_004.jpg');
      background_16_9_paths.push('assets/images/backgrounds/16_9/16_9_005.jpg');
      background_16_9_paths.push('assets/images/backgrounds/16_9/16_9_006.jpg');
      background_16_9_paths.push('assets/images/backgrounds/16_9/16_9_007.jpg');

      background_9_16_paths.push('assets/images/backgrounds/9_16/9_16_001.jpg');
      background_9_16_paths.push('assets/images/backgrounds/9_16/9_16_002.jpg');
      background_9_16_paths.push('assets/images/backgrounds/9_16/9_16_003.jpg');
      background_9_16_paths.push('assets/images/backgrounds/9_16/9_16_004.jpg');
      background_9_16_paths.push('assets/images/backgrounds/9_16/9_16_005.jpg');
  ...
  //paper_normal_texture_path.push('https://leokamwathi.github.io/PixelNinja/assets/images/papers/normal/paper_3.png')
   paper_normal_texture_path.push('assets/images/papers/normal/paper_4.png')
   paper_normal_texture_path.push('assets/images/papers/normal/paper_5.png')
   paper_normal_texture_path.push('assets/images/papers/normal/paper_6.png')
   paper_normal_texture_path.push('assets/images/papers/normal/paper_7.png')
   paper_normal_texture_path.push('assets/images/papers/normal/paper_8.png')
   paper_normal_texture_path.push('assets/images/papers/normal/paper_9.png')
  
  
  //paper_normal_texture_path = 'https://leokamwathi.github.io/PixelNinja/assets/images/papers/normal/paper.png'
  
  paper_normal_json_path = 'assets/images/papers/normal/paper.json'
  
  //Normal Paper
  
  paper_normal_texture_paths.push('assets/images/papers/normal/paper.png?')
  paper_normal_texture_paths.push('assets/images/papers/normal/paper_a.png')
  paper_normal_texture_paths.push('assets/images/papers/normal/paper_b.png')
  paper_normal_texture_paths.push('assets/images/papers/normal/paper_aa.png')
  paper_normal_texture_paths.push('assets/images/papers/normal/paper_ab.png')
  paper_normal_texture_paths.push('assets/images/papers/normal/paper_ba.png')
  paper_normal_texture_paths.push('assets/images/papers/normal/paper_bb.png')
  paper_normal_texture_paths.push('assets/images/papers/normal/paper_aaa.png')
  paper_normal_texture_paths.push('assets/images/papers/normal/paper_aab.png')
  paper_normal_texture_paths.push('assets/images/papers/normal/paper_aaa_25.png')
  paper_normal_texture_paths.push('assets/images/papers/normal/paper_aab_25.png')
  
  //Glass
  
      var glass_texture_path = 'assets/images/papers/normal/glass.png?'
  
  //Mask
  var mask_aaa_texture_path = 'assets/images/papers/normal/mask_aaa.png?'
  
  //Blade [HP]
  blades_path.push("assets/images/blades/hd_blades_0.png")
  blades_path.push("assets/images/blades/hd_blades_1.png")
  blades_path.push("assets/images/blades/hd_blades_2.png")
  blades_path.push("assets/images/blades/hd_blades_3.png")
  blades_path.push("assets/images/blades/hd_blades_4.png")
  blades_path.push("assets/images/blades/hd_blades_5.png")
  blades_path.push("assets/images/blades/hd_blades_6.png")
  
    
    //UI BUTTONS
    var play_button_path   = "assets/images/ui/Play_Button_2_a.png"
	var easy_button_path   = "assets/images/ui/Easy_Button_a.png"
	var normal_button_path = "assets/images/ui/Normal_Button_a.png"
	var hard_button_path   = "assets/images/ui/Hard_Button_a.png"
    var level_button_0_star_path = "assets/images/ui/level_button_0_star.png"
    var level_button_1_star_path = "assets/images/ui/level_button_1_star.png"
    var level_button_2_star_path = "assets/images/ui/level_button_2_star.png"
    var level_button_3_star_path = "assets/images/ui/level_button_3_star.png"
  ...
  music_paths.push('assets/music/music_001.mp3')
  music_paths.push('assets/music/music_002.mp3')
  music_paths.push('assets/music/music_003.mp3')
  music_paths.push('assets/music/music_004.mp3')
  music_paths.push('assets/music/music_005.mp3')
  music_paths.push('assets/music/music_006.mp3')
  
  
   
  var sword_phase_path =    "assets/sounds/phase_sfx_001.mp3"
  var sword_slash_path =    "assets/sounds/sword_sfx.mp3"
  var glass_break_path =    "assets/sounds/glass_sfx.mp3"
  var critical_hit_path =   "assets/sounds/sword_epic_002.mp3"
  //paper_throw_sfx_001.mp3
  var glass_throw_path =    "assets/sounds/glass_throw_sfx_001.mp3"
  var paper_throw_path =    "assets/sounds/paper_throw_sfx_002.mp3"
  var freeze_effect_path =  "assets/sounds/freeze_sfx_001.mp3"
  var wind_effect_path =    "assets/sounds/wind_sfx_001.mp3"
  var lightning_effect_path = "assets/sounds/lightning_sfx_001.mp3"
  
  
  var yoooo_path = "assets/sounds/Japanese_Yoooo_sfx.mp3"
  

  var paper_cut_path_001 = "assets/sounds/cut_001_sfx.mp3"
  var paper_cut_path_002 = "assets/sounds/cut_002_sfx.mp3"
  var paper_cut_path_003 = "assets/sounds/cut_003_sfx.mp3"
  var paper_cut_path_004 = "assets/sounds/cut_004_sfx.mp3"
  var paper_cut_path_005 = "assets/sounds/cut_005_sfx.mp3"
  ...
  background_dojo_paths.forEach((path,index)=>{game.load.image("background_dojo_"+index,path)})
      background_16_9_paths.forEach((path, index) => { game.load.image("background_16_9_" + index, path) })
      background_9_16_paths.forEach((path, index) => { game.load.image("background_9_16_" + index, path) })
      background_animated_paths.forEach((path, index) => { game.load.image("background_animated_" + index, path) })
 ...
 create() {
     ...
     if (newGame) {
         ...
         background_dojo_paths.forEach((d, index) => {
             ...
             background_dojo[index].depth = -100 + index;
             //game.load.image("background_dojo_"+index,path)

         })

         background_16_9 = [];
         background_16_9_paths.forEach((d, index) => {
             background_16_9.push(game.add.image(0, 0, 'background_16_9_' + index))
             //let bg_scale = h/background_dojo[index].height
             background_16_9[index].height = h // background_dojo[index].height * bg_scale
             background_16_9[index].width = w // background_dojo[index].width * bg_scale
             background_16_9[index].visible = false
             background_16_9[index].depth = -100 + index;
             //game.load.image("background_dojo_"+index,path)

         })

         background_9_16 = [];
         background_9_16_paths.forEach((d, index) => {
             background_9_16.push(game.add.image(0, 0, 'background_9_16_' + index))
             //let bg_scale = h/background_dojo[index].height
             background_9_16[index].height = h // background_dojo[index].height * bg_scale
             background_9_16[index].width = w // background_dojo[index].width * bg_scale
             background_9_16[index].visible = false
             background_9_16[index].depth = -100 + index;
             //game.load.image("background_dojo_"+index,path)

         })

         background_animated = [];
         background_animated_paths.forEach((d, index) => {
             background_animated.push(game.add.image(0, 0, 'background_animated_' + index))
             //let bg_scale = h/background_dojo[index].height
             background_animated[index].height = h // background_dojo[index].height * bg_scale
             background_animated[index].width = w // background_dojo[index].width * bg_scale
             background_animated[index].visible = false
             background_animated[index].depth = -100 + index;
             //game.load.image("background_dojo_"+index,path)
         ...
         console.log("Backgrounds = " + background_dojo.length)
         console.dir(background_dojo)
         //game.add.tileSprite(0, 0, 1000, 600, 'background');

        
         //background_dojo[0].visible = true
         ...
         current_blades = max_blades;
         blades_cartridge.forEach((b, i) => { if (i != current_blades) { blades_cartridge[i].visible = false } })
     ...
     background_dojo.forEach((d, index) => { background_dojo[index].visible = false })
     background_16_9.forEach((d, index) => { background_16_9[index].visible = false })
     background_9_16.forEach((d, index) => { background_9_16[index].visible = false })
     background_animated.forEach((d, index) => { background_animated[index].visible = false })

    // background_dojo[parseInt(Math.random() * background_dojo.length)].visible = true
     if (h > w) {
         background_9_16[parseInt(Math.random() * background_9_16.length)].visible = true
     } else {
         background_16_9[parseInt(Math.random() * background_16_9.length)].visible = true
     }
    // background_9_16[parseInt(Math.random() * background_9_19.length)].visible = true
    // background_animated[parseInt(Math.random() * background_animated.length)].visible = true
